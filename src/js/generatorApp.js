...
document.addEventListener('DOMContentLoaded', () => {
	...
	window.addEventListener('click', (event) => {
		...
		// account bar
		if (
			target.classList.contains('account-ctr') ||
			target.matches('.overlay.account') ||
			target.classList.contains('btn-account-setting-close')
		) {
		...
		// bookmark btn
		if (
			target.classList.contains('btn-bookmark') ||
			target.classList.contains('btn-bookmark-close') ||
			target.matches('.overlay.bookmark')
		) {
		...
		// save pallete btn
		if (
			target.classList.contains('btn-save-pallete') ||
			target.classList.contains('btn-save-pallete-close')
		) {
		...
		if (
			...
			target.classList.contains('btn-close-nav')
		) {
